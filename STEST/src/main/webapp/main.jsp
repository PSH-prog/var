	...
	<ul  style='list-style:none;margin-top:10px;margin-left:10px'>
		...
		<!-- 검색 버튼 UI -->
			<button type='button' class='navyBtn' 
				...
				<img src='/STEST2/img/search_btn.png' width=41px height=41px style='transform:translateY(17%)'>
			</button>
		</form>
		...
		while(rs.next()){
			...
			switch(weather) {
			case "비":
				src = "<img src='/STEST2/img/rain_img.png' width='100' heigh='100'>";
				break;
			case "맑음":
				src = "<img src='/STEST2/img/snn_img.png' width='100' heigh='100'>";
				break;
			case "눈":
				src = "<img src='/STEST2/img/snn_img.png' width='100' heigh='100'>";
				break;
			case "흐림":
				src = "<img src='/STEST2/img/cld_img.png' width='100' heigh='100'>";
				break;
			case "구름많음":
				src = "<img src='/STEST2/img/mncld_img.png' width='100' heigh='100'>";
				break;
			default:
